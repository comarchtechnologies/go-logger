...
[![Go Report Card](https://goreportcard.com/badge/github.com/comarchtechnologies/go-logger)](https://goreportcard.com/report/github.com/comarchtechnologies/go-logger)
[![Godocs](https://img.shields.io/badge/golang-documentation-blue.svg)](https://godoc.org/github.com/comarchtechnologies/go-logger)
...
```go
import "github.com/comarchtechnologies/go-logger"
...
```go
import "github.com/comarchtechnologies/go-logger/shims/logrus"
...
import (
	...
	"github.com/comarchtechnologies/go-logger/shims/logrus"
)
...
```go
import "github.com/comarchtechnologies/go-logger/shims/zerolog"
...
import (
	...
	"github.com/comarchtechnologies/go-logger/shims/zerolog"
)
